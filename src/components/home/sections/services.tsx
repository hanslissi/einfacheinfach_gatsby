    ...
    return (
        <SectionWrapper id="services">
            <div className="relative bg-primary flex flex-col items-center gap-12 py-20 md:py-32 md:gap-32">
                <h1 ref={refHeadline} className="text-white">Wir erklären - <br />
                ...
                <p className="text-white max-w-[800px] px-10">
                    Ist Ihre Zielgruppe verwirrt? Hat sie Fragen über Ihre Services? Suchen sie nach klaren und schnellen Antworten?
                    Unsere Videos machen komplexe Themen einfach! In kürzester Zeit und auf unterhaltsame Weise erklärt.
