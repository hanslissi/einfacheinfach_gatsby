...
const Work = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative w-full mt-2 flex flex-col justify-center gap-10 px-10 py-10 md:py-24 md:gap-20 md:mt-0 md:px-24 lg:px-60"
        ref={refWorkCardsDiv}
      >
        <LongCurvyArrrowLineSvg
