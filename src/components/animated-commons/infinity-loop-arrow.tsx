...
const InfinityLoopArrow = ({ className, duration = 4 }: InfinityLoopArrowProps) => {
    const transition: Transition = { duration: duration, repeat: Infinity, repeatType: "loop", ease: "linear" }
    const transitionDelayed: Transition = { duration: duration, repeat: Infinity, repeatType: "loop", delay: duration * 0.375, ease: "linear" }
